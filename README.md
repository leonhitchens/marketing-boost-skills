...
| LinkedIn Post Writing | `linkedin-post-writing-skill/` | Writes, drafts, reviews, and improves LinkedIn posts, polls, and short articles in Leon Hitchens' personal-brand voice using the WunderContent system from his LinkedIn Activator Playbook — covers the two audience personas (Ex-Corporate John, Startup Corey), the four content tracks, hook/story/CTA anatomy, the anti-Leon edit rules, and ships ready-to-paste posts. Includes reference banks of post ideas, polls, real Leon stories, and deep persona/voice detail. |
